    ...
    <nav className={`${styles.container} glass-border`}>
      <div className="max-w-6xl flex mr-auto ml-auto pt-4 pr-6 pb-4 pl-6 items-center justify-center">
        <div className="flex gap-12 text-sm text-gray-400 items-center">
          <Link href="/" className={`transition-colors flex flex-col items-center gap-1 ${isHome ? "text-white" : "hover:text-white"}`} aria-current={isHome ? "page" : undefined}>
          ...
          <Link href="/marketplace" className={`transition-colors flex flex-col items-center gap-1 ${isMarketplace ? "text-white" : "hover:text-white"}`} aria-current={isMarketplace ? "page" : undefined}>
          ...
          <Link href="/settings" className={`transition-colors flex flex-col items-center gap-1 ${isSettings ? "text-white" : "hover:text-white"}`} aria-current={isSettings ? "page" : undefined}>
